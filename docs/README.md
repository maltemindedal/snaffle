...
| [Download large files](guides/downloading-large-files.md) | Progress bars, `--progress` behaviour, streaming to disk from Python, and the `speedups` extra. | Anyone moving payloads big enough to care. |
...
Every file under `docs/` appears in a table above. Add a row whenever you add a
document.
